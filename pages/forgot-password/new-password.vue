            ...
            <div class="signinform">
                ...
                <div class="container">
                         <div class="login-form " style="height: max-content;">
                            ...
                            <br>
                            <br>
                            <form @submit.prevent="handleSubmit" style="margin-top: -30px;">
                              <div style="position:absolute;width:max-content;background: white;margin-top: -15px;" class="mx-4" v-if="password">
                                <small>New password</small>
                              </div>
                              <div class="d-flex">
                                <input :type="eyeNewPassword == 'true' ? 'text' : 'password'"   class="form-control" placeholder="New password" v-model="password" minlength="8" required/>
                              ...
                              <br/>
                              <small class="text-danger text-left" v-if="!passwordMatch  || !password> 8">Must be atleast 8 charecters which contain both number and special charecter</small>
                              <div class="d-flex">
                                ...
                                <div style="position:absolute;width:max-content;background: white;margin-top: 9px;"  v-if="confirmpassword" class="mx-3">
                             ...
                             <br/>
                             <NuxtLink to="/dashboards"><input type="submit" class="btn w-100 btn-primary" value="Next" /></NuxtLink>
                            </form>
