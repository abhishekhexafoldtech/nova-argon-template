  ...
  <div class="container-area">
    ...
    <div class="table_header">
      <el-button
        ...
        ><span class="text-white"><i>+</i>Add Admin</span>
      </el-button>
      <el-button
        ...
        ><span class="text-white"><i>+</i>Add Role</span>
      </el-button>
      <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
        <el-tab-pane label="Admins" name="first">
          <div class="table-area" v-if="false">
            <Table
          ...
          <div v-else>
            <BlankPage
              mainTitle="Admin not added yet"
              title=""
              subTitle="Start by adding first admin"
              buttonText="Add new admin"
              :handleBlankPage="handleBlankPage"
              :blankImage="adminBlankImage"
            />
          </div>
        </el-tab-pane>
...
import adminBlankImage from "@/assets/svg/blank_admin.svg";

const router = useRouter();
const activeName = ref("first");
const handleBlankPage = () => {
  router.push("/onboarding/add-admin")
};
